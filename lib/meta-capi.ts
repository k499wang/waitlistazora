...
// dropping events.
//
// NOTE: The authoritative server-side Purchase event is sent from the
// RevenueCat web checkout webhook (supabase/functions/revenuecat-web-checkout-webhook),
// not from here — it's the only place that knows when money actually moved.
