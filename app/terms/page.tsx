...
export default function TermsAndConditions() {
  return (
    <main className="min-h-screen bg-[#fdfdfc] text-[#1a1c1a] py-16 px-6">
      <article className="max-w-3xl mx-auto prose prose-neutral prose-headings:font-extrabold prose-headings:tracking-tight">
        ...
        <section className="space-y-6 text-[#666c68]">
          ...
          <h2 className="text-xl font-bold text-[#1a1c1a]">1. Eligibility</h2>
          ...
          <h2 className="text-xl font-bold text-[#1a1c1a]">2. Description of Service</h2>
          ...
          <h2 className="text-xl font-bold text-[#1a1c1a]">3. Not Medical Advice</h2>
          ...
          <h2 className="text-xl font-bold text-[#1a1c1a]">8. Free Trials</h2>
          ...
          <h2 className="text-xl font-bold text-[#1a1c1a]">9. Acceptable Use</h2>
          ...
          <h2 className="text-xl font-bold text-[#1a1c1a]">10. Accuracy of Information</h2>
          ...
          <h2 className="text-xl font-bold text-[#1a1c1a]">11. Limitation of Liability</h2>
          ...
          <h2 className="text-xl font-bold text-[#1a1c1a]">14. Changes to Terms</h2>
          <p>We may update these Terms at any time. Continued use of the App after changes means you accept the updated Terms.</p>

          <h2 className="text-xl font-bold text-[#1a1c1a]">15. Contact Information</h2>
